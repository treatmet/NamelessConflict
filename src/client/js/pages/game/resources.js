...
Img.escExit = new Image();
Img.escExit.src = "/src/client/img/escExit.png";
...
Img.muteButton = new Image();
Img.muteButton.src = "/src/client/img/muteButton.png";
Img.muteButtonHover = new Image();
Img.muteButtonHover.src = "/src/client/img/muteButtonHover.png";
Img.enterPurchase = new Image();
Img.enterPurchase.src = "/src/client/img/enterPurchase.png";
...
//Medals
Img.doubleKill = new Image();
Img.doubleKill.src = "/src/client/img/medals/doubleKill.png";
Img.tripleKill = new Image();
Img.tripleKill.src = "/src/client/img/medals/tripleKill.png";
Img.overKill = new Image();
Img.overKill.src = "/src/client/img/medals/overKill.png";
Img.killception = new Image();
Img.killception.src = "/src/client/img/medals/killception.png";
Img.yoDawg = new Image();
Img.yoDawg.src = "/src/client/img/medals/yoDawg.png";
Img.killingSpree = new Image();
Img.killingSpree.src = "/src/client/img/medals/killingSpree.png";
Img.massacre = new Image();
Img.massacre.src = "/src/client/img/medals/massacre.png";
Img.genocide = new Image();
Img.genocide.src = "/src/client/img/medals/genocide.png";
Img.annihilation = new Image();
Img.annihilation.src = "/src/client/img/medals/annihilation.png";
Img.goodFriend = new Image();
Img.goodFriend.src = "/src/client/img/medals/goodFriend.png";
Img.bestFriend = new Image();
Img.bestFriend.src = "/src/client/img/medals/bestFriend.png";
Img.friendsTillTheEnd = new Image();
Img.friendsTillTheEnd.src = "/src/client/img/medals/friendsTillTheEnd.png";
Img.lastLaugh = new Image();
Img.lastLaugh.src = "/src/client/img/medals/lastLaugh.png";
Img.snipe = new Image();
Img.snipe.src = "/src/client/img/medals/snipe.png";
Img.assassin = new Image();
Img.assassin.src = "/src/client/img/medals/assassin.png";


window.Img = Img;

var sfx = {};
sfx.Pistol = new Howl({src: ['/src/client/sfx/pistol.mp3']});
sfx.PistolMine = new Howl({src: ['/src/client/sfx/pistol.mp3']});
sfx.MG = new Howl({src: ['/src/client/sfx/mgShot.mp3']});
sfx.MGMine = new Howl({src: ['/src/client/sfx/mgShot.mp3']});
sfx.DP = new Howl({src: ['/src/client/sfx/double_pistolsLoud.mp3']});
sfx.DPMine = new Howl({src: ['/src/client/sfx/double_pistolsLoud.mp3']});
sfx.SG = new Howl({src: ['/src/client/sfx/shotgun.mp3']});
sfx.Capture = new Howl({src: ['/src/client/sfx/capture1.mp3']});
sfx.Hit1 = new Howl({src: ['/src/client/sfx/hit1.mp3']});
//sfx.Hit1.volume(.5);
sfx.Hit2 = new Howl({src: ['/src/client/sfx/hit2.mp3']});
sfx.Kill = new Howl({src: ['/src/client/sfx/kill.mp3']});
sfx.Kill.volume(.8);
sfx.killAchieved = new Howl({src: ['/src/client/sfx/killAchieved.mp3']});
//sfx.killAchieved.volume(.7);
sfx.Explosion1 = new Howl({src: ['/src/client/sfx/explosion1.mp3']});
sfx.Explosion2 = new Howl({src: ['/src/client/sfx/explosion2.mp3']});
sfx.Explosion3 = new Howl({src: ['/src/client/sfx/explosion3.mp3']});
sfx.Explosion4 = new Howl({src: ['/src/client/sfx/explosion4.mp3']});
sfx.Clink1 = new Howl({src: ['/src/client/sfx/clink1.mp3']});
sfx.Clink2 = new Howl({src: ['/src/client/sfx/clink2.mp3']});
sfx.Clink3 = new Howl({src: ['/src/client/sfx/clink1.mp3']});
sfx.Clink4 = new Howl({src: ['/src/client/sfx/clink2.mp3']});
sfx.PinPull1 = new Howl({src: ['/src/client/sfx/pinPull1.mp3']});
sfx.PinPull2 = new Howl({src: ['/src/client/sfx/pinPull2.mp3']});
sfx.GetItem = new Howl({src: ['/src/client/sfx/getItem.mp3']});
sfx.PinPull1.volume(.6);
sfx.PinPull2.volume(.4);

sfx.StealGood = new Howl({src: ['/src/client/sfx/drumroll.mp3']});
sfx.StealBad = new Howl({src: ['/src/client/sfx/steal2.mp3']});
sfx.StealGood.volume(0.75);
sfx.StealBad.volume(0.75);
sfx.BagGrab = new Howl({src: ['/src/client/sfx/bagGrab.mp3']});
sfx.BagGrab.volume(.6);
sfx.TimeWarning = new Howl({src: ['/src/client/sfx/30sec.mp3']});
sfx.TimeWarning.volume(.7);
sfx.SuddenDeath = new Howl({src: ['/src/client/sfx/suddenDeath.mp3']});

sfx.PistolReload = new Howl({src: ['/src/client/sfx/pistolReload.mp3']});
sfx.DPReload = new Howl({src: ['/src/client/sfx/DPReload.mp3']});
sfx.MGReload = new Howl({src: ['/src/client/sfx/MGReload.mp3']});
sfx.SGReload1 = new Howl({src: ['/src/client/sfx/SGReload3.mp3']});
sfx.SGReload2 = new Howl({src: ['/src/client/sfx/SGReload4.mp3']});
sfx.SGReload3 = new Howl({src: ['/src/client/sfx/SGReload2.mp3']});
sfx.SGReload4 = new Howl({src: ['/src/client/sfx/SGReload1.mp3']});

sfx.PistolEquip = new Howl({src: ['/src/client/sfx/Pistolequip2.mp3']});
sfx.DPEquip = new Howl({src: ['/src/client/sfx/dpPick.mp3']});
sfx.MGEquip = new Howl({src: ['/src/client/sfx/MGequip.mp3']});
sfx.SGEquip = new Howl({src: ['/src/client/sfx/SGequipLoud.mp3']});
sfx.LaserEquip = new Howl({src: ['/src/client/sfx/laserEquip.mp3']});
sfx.LaserCharging = new Howl({src: ['/src/client/sfx/laserChargingFast.mp3']});
sfx.LaserCharging.volume(0.6);
sfx.LaserDischarge = new Howl({src: ['/src/client/sfx/laserDischarge.mp3']});

sfx.Click = new Howl({src: ['/src/client/sfx/click.mp3']});
sfx.Click.volume(0.6);
sfx.HealthPackGrab = new Howl({src: ['/src/client/sfx/healthPackGrab.mp3']});
sfx.HealthPackGrab.volume(.5);
sfx.WeaponDrop = new Howl({src: ['/src/client/sfx/weaponDrop2.mp3']});
sfx.WeaponDrop.volume(.3);

sfx.Purchase = new Howl({src: ['/src/client/sfx/purchase.mp3']});
sfx.Error = new Howl({src: ['/src/client/sfx/error2.mp3']});
sfx.MenuMove = new Howl({src: ['/src/client/sfx/comp-beep.wav']});
sfx.MenuMove.volume(.5);

sfx.Whoosh = new Howl({src: ['/src/client/sfx/whoosh.mp3']});
sfx.Whoosh.volume(.25);
sfx.Punch = new Howl({src: ['/src/client/sfx/punch.mp3']});
sfx.Warning = new Howl({src: ['/src/client/sfx/warning.mp3']}); //energyWarning
sfx.Warning.on('fade', function(){
	sfx.Warning.stop();
});
sfx.Warning2 = new Howl({src: ['/src/client/sfx/warning2.mp3']});
sfx.Warning2.on('fade', function(){
	sfx.Warning2.stop();
});
sfx.Charge = new Howl({src: ['/src/client/sfx/charging3.mp3']});
//sfx.Charge.volume(.9);
sfx.Charge.on('fade', function(){
	sfx.Charge.stop();
});
sfx.Decharge = new Howl({src: ['/src/client/sfx/decharge3.mp3']});
//sfx.Decharge.volume(.6);
sfx.Boost = new Howl({src: ['/src/client/sfx/boost5.mp3']});
sfx.BoostRainbow = new Howl({src: ['/src/client/sfx/boostRainbow.mp3']});
sfx.BoostLaser = new Howl({src: ['/src/client/sfx/boostLaser.mp3']});
sfx.BoostBlast = new Howl({src: ['/src/client/sfx/boostBlast.mp3']});
sfx.BoostLightning = new Howl({src: ['/src/client/sfx/boostLightning.mp3']});
...
sfx.LevelUp.volume(.7);

sfx.DefeatMusic = new Howl({src: ['/src/client/sfx/music/theme-sad-short.mp3']});
sfx.VictoryMusic = new Howl({src: ['/src/client/sfx/music/theme-victory-short.mp3']});
sfx.DefeatMusic.volume(.3);
sfx.VictoryMusic.volume(.3);
sfx.ProgressBar = new Howl({src: ['/src/client/sfx/progressBar.mp3']});
sfx.ProgressBar.volume(.18);
sfx.ProgressBarReverse = new Howl({src: ['/src/client/sfx/progressBarReverse.mp3']});
sfx.ProgressBarReverse.volume(.18);
window.sfx = sfx;
...
function playGrenadeExplosionSfx(x, y){ //playExplosionSfx
	...
	if (!mute){
		var explosion_sounds = ["Explosion1", "Explosion2", "Explosion3", "Explosion4"];
		var randy = Math.floor(Math.random() * explosion_sounds.length);
		var srandy = randy;
		do {
			if (!eval(`sfx.${explosion_sounds[srandy]}.playing()`)) {
				sfxRangedLoud(explosion_sounds[srandy], x, y, maxDist, minDist);;
				break;
			}
			console.log(srandy);
			srandy++;
			srandy = srandy % explosion_sounds.length;
		} while (randy != srandy);
	}
}
...
function playGrenadeClinkSfx(x, y){ //playExplosionSfx
	if (!mute){
		var clink_sounds = ["Clink1", "Clink2", "Clink3", "Clink4"];
		var randy = Math.floor(Math.random() * clink_sounds.length);
		var srandy = randy;
		do {
			if (!eval(`sfx.${clink_sounds[srandy]}.playing()`)) {
				sfxRangedLoud(clink_sounds[srandy], x, y);
				break;
			}
			console.log(srandy);
			srandy++;
			srandy = srandy % clink_sounds.length;
		} while (randy != srandy)
	}
}
...
function sfxPlay(SFX, volume = null){
	if (mute) return;
    if (typeof volume == 'number') sfx[SFX].volume = volume;
    sfx[SFX].play();
}
